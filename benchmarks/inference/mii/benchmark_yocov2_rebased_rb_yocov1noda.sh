...
# OUT_DIR=./results_20250326_benchmark_yocov2newdrop_yocov1noda_cuda124_py312_longseq
# LOAD_FORMAT=dummy
# BACKEND="vllm"
...
OUT_DIR=./results_20250328_benchmark_yocov2newdrop_yocov1noda_cuda124_py312_longseq_prompt
LOAD_FORMAT=dummy
BACKEND="vllm"
MODEL="/data/users/adatkins/dev/phivnext/yoco/yocov2/MoE/qyocov2/checkpoint/"
