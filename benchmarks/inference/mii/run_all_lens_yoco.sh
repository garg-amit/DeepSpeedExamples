...
for MODEL in ${MODELS[@]}; do
    ...
    python ./run_benchmark.py --backend ${BACKEND}  --model ${MODEL} --mean_prompt_length 50 --mean_max_new_tokens 50 --tp_size 1 --out_json_dir ${OUT_DIR} --load_format ${LOAD_FORMAT} --stream --warmup 1 --overwrite_results --num_requests 16
