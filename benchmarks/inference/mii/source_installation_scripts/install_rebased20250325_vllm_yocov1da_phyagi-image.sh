#!/bin/bash
# source me!
conda create -n myenv20250325RBphyagipy312v1da python=3.12 -y
## If conda activate fails, then need to run this command 
source activate myenv20250325RBphyagipy312v1da
conda activate myenv20250325RBphyagipy312v1da
...
cd /data/users/adatkins/dev/phivnext/yoco/yocov2/20250325_rebased_yocov1DA_vllm
