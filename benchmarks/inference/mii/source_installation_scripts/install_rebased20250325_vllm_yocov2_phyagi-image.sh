#!/bin/bash
# source me!
conda create -n myenv20250325RBphyagipy312 python=3.12 -y
## If conda activate fails, then need to run this command 
source activate myenv20250325RBphyagipy312
conda activate myenv20250325RBphyagipy312
...
cd /data/users/adatkins/dev/phivnext/yoco/yocov2/20250325_rebased_vllm
